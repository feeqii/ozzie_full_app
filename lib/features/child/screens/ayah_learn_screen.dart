          ...
          return Column(
            ...
            children: [
              ...
              AppCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(ayah.arabic, style: AppTextStyles.arabicTitle, textAlign: TextAlign.center),
                    const SizedBox(height: AppSpacing.sm),
                    Text(ayah.transliteration, style: AppTextStyles.body, textAlign: TextAlign.center),
                    const SizedBox(height: AppSpacing.sm),
              ...
              PrimaryButton(
                ...
                onPressed: () => context.go('/child/surah/$surahId/ayah/$ayahId/recite'),
              ),
              const SizedBox(height: AppSpacing.sm),
              SecondaryButton(
                label: 'Back to overview',
                onPressed: () => context.go('/child/surah/$surahId'),
              ),
            ],
          );
        },
